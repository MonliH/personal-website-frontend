...
export default function Home() {
  return (
    <main className="px-4 lg:px-28 py-32">
      <LenisScroller />
      <HomeSvg className="absolute top-0 h-[690px] w-11/12 lg:left-16 lg:w-[80%] lg:h-auto 2xl:h-[90%] 2xl:w-[85%] pointer-events-none" />
      ...
      <p className="left-[45%] w-1/2 absolute top-[700px] text-lg lg:top-[645px] lg:w-[31rem] lg:text-2xl lg:left-[calc(7.5rem+49vw)] 2xl:left-[calc(12rem+49vw)] 2xl:top-[calc(80%-50px)]">
      ...
      <Sep2Svg className="absolute left-0 mt-24" />
      <div className="relative mt-52 lg:mt-80 2xl:mt-96">
        ...
        <div className="flex flex-row items-end gap-8 mb-16 lg:mb-28 flex-wrap lg:flex-nowrap">
          ...
          <p>
            A few years ago I started <Link href="https://www.riftium.ca" target="_blank" className="underline">Riftium</Link>, a web design firm, with{" "}
            <Link
              href="https://davidy.li"
              target="_blank"
            >
              my brother
            </Link>
          ...
          <Fragment key={i}>
            ...
            <div className="flex flex-row flex-wrap gap-x-2">
              <Link
                href={project.link}
                target="_blank"
                className="font-light text-md lg:mr-4 lg:text-lg"
              >
                {project.description}
              </Link>
              <div>
                <p className="pr-2 inline-block text-md lg:text-lg">|</p>
                <p className="inline-block text-md lg:text-lg">{project.result}</p>
              </div>
            </div>
          </Fragment>
        ))}
